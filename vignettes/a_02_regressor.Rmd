...
If you want louder-versus-quieter *conditional on sound*, pass a `mask` for
the on-period (silence stays 0 after centering) and a separate boxcar for
sound presence. That is not an affine transform of the all-sample RMS series.
Do not drop silent samples before centering: that silently turns the all-TR
model into the sparse one.
